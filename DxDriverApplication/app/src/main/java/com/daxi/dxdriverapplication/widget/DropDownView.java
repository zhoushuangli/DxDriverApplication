...
public class DropDownView extends RelativeLayout {
    ...
    private void handleAttrs(Context context, AttributeSet attrs) {
        if (context != null && attrs != null) {
            ...
            try {
                backgroundColor = a.getColor(R.styleable.DropDownView_containerBackgroundColor, ContextCompat.getColor(context, R.color.textSaDownColor));
                overlayColor = a.getColor(R.styleable.DropDownView_overlayColor, ContextCompat.getColor(context, R.color.tv_999999));
            } finally {
                a.recycle();
            }
        }
        if (backgroundColor == 0) {
            backgroundColor = ContextCompat.getColor(context, R.color.textSaDownColor);
        }
        if (overlayColor == 0) {
            overlayColor = ContextCompat.getColor(context, R.color.tv_999999);
        }
    }

...
public class NumberProgressBar extends View {
    ...
    private void initData() {
        ...
        // 已完成进度条画笔的属性
        paintInit.setColor(context.getResources().getColor(R.color.home_title_bg));
        ...
        // 大圆画笔
        paintEndBig.setColor(context.getResources().getColor(R.color.home_title_bg));
        ...
        paintText.setColor(context.getResources().getColor(R.color.home_title_bg));
